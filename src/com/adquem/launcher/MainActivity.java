...
AdquemPlayer vv;
    ...
    protected void onCreate(Bundle savedInstanceState) {
			...
			public boolean onTouch(View v, MotionEvent event) {
				// TODO Auto-generated method stub
				   if(event.getAction() == MotionEvent.ACTION_DOWN && longClickTimer == null)
				    {
					   if(vv.getSound()){vv.mute();}else{vv.unmute();}
        ...
        vv.setVideoPath("android.resource://" + getPackageName() +"/"+ R.raw.gorditayoo);
        ...
        botonApps.setOnClickListener(new OnClickListener() {
			...
			public void onClick(View v) {
				...
				startActivity(new Intent(MainActivity.this, LanzadorActivity.class));
    ...
    class LongClickTask extends TimerTask {
        ...
        public void run() {
            ...
            longClickTimer.purge();
            longClickTimer = null;
            startActivity(new Intent(Intent.ACTION_VIEW, Uri.parse("https://sitioseguro.cablevision.net.mx/")));
                    }
    }
}
